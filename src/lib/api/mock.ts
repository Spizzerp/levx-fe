...
const MARKETS: Market[] = [
  ...
  makeMarket({
    ...
    seasonKey: 'BTC/USDC:2026:14d',
    seasonMetadata: {
      seasonKey: 'BTC/USDC:2026:14d',
      seasonId: 'btc-2026-14d',
      assetSeasonAddress: MOCK_SEASON_GROUP.address,
      parentStatus: MOCK_SEASON_GROUP.status,
      groupKeyHash: MOCK_SEASON_GROUP.groupKeyHash,
      groupKind: MOCK_SEASON_GROUP.kind,
      parentGroup: MOCK_SEASON_GROUP.parentGroup,
      pair: 'BTC/USDC',
      productSeason: '2026',
      horizon: '14d',
      timeframeSeconds: MOCK_SEASON_LINK.timeframeSeconds,
      startTime: NOW - 30 * DAY,
      endTime: NOW + 365 * DAY,
      description: '2026 BTC season markets grouped by provider-indexed 14D horizon metadata.',
    },
  }),
