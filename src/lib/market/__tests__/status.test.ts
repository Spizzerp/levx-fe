...
describe('market status helpers', () => {
  it('mirrors the on-chain 3/4 checkpoint wagering cutoff', () => {
    expect(getWageringCutoffCheckpoint(42)).toBe(31)
    expect(getWageringCutoffCheckpoint(336)).toBe(252)
  })
